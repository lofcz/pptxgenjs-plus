...
| `color`               | string             |         |         | text color                | hex color code or [scheme color](./shapes-and-schemes). Ex: `{ color:'0088CC' }`                                 |
| `fill`                | string             |         |         | fill/bkgd color           | hex color code or [scheme color](./shapes-and-schemes). Ex: `{ color:'0088CC' }`                                 |
...
| `highlight`           | string             |         |         | highlight color           | hex color code or [scheme color](./shapes-and-schemes). Ex: `{ color:'0088CC' }`                                 |
...
| `color`   | string |         |         | text color   | hex color code or [scheme color constant](./shapes-and-schemes). Ex: `{ color:'0088CC' }` |
